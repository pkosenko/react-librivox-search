...
/***/ function(module, exports, __webpack_require__) {
	...
	var _librivoxStore = __webpack_require__(158);

	var _librivoxStore2 = _interopRequireDefault(_librivoxStore);

	var _librivoxActions = __webpack_require__(173);

	var librivoxActions = _interopRequireWildcard(_librivoxActions);
	...
	var SearchFilter = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement('input', { type: 'text', placeholder: 'Search', onChange: this.handleChange })
	    );
	  }
	});
	...
	// unless we plan on using redux-react-router
	// This is not importing correctly?


	var BookDataDisplay = _react2.default.createClass({
	  displayName: 'BookDataDisplay',
	  ...
	  */
	  propTypes: {
	    data: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.object), // grabs the data -- but do we need this here
	    currentBook: _react2.default.PropTypes.object,
	    id: _react2.default.PropTypes.string // I take it that parameters are going to come in as strings, even if they are numbers
	  },
	  /*
	  contextTypes: {
	...
	var SearchResultsDisplay = _react2.default.createClass({
	  ...
	  propTypes: {
	    data: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.object), // grabs the data -- but do we need this here
	    currentBook: _react2.default.PropTypes.object,
	    id: _react2.default.PropTypes.number // I take it that parameters are going to come in as strings, even if they are numbers
	  },
	    ...
	    */
	    return _react2.default.createElement(
	      ...
	      this.props.data.map(function (bookObject) {
	        ...
	        return _react2.default.createElement(BookListItem, { bookObject: bookObject, key: bookObject.id });
	      }),
	...
	var BookListItem = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        null,
	        'AUTHOR(S): ',
	        bookObject.authors[0].first_name + ' ' + bookObject.authors[0].last_name
	      ),
	      _react2.default.createElement(
	        'p',
	        null,
	...
	*/
	...
	var Search = _react2.default.createClass({
	  ...
	  propTypes: {
	    data: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.object) // data is object  //  data.books is array
	  },
	  getDefaultProps: function getDefaultProps() {
	    return {
	      data: [] //
	  ...
	  onSubmit: function onSubmit(e) {
	    ...
	    console.log('librivoxStore: ' + JSON.stringify(_librivoxStore2.default)); // nothing = {}
	    // Dispatch action on stores.
	    _librivoxStore2.default.dispatch(librivoxActions.getBookData('author/', this.state.searchTerm));
	  ...
	  searchTermChange: function searchTermChange(event) {
	    // This just sets the input data associated with the text box. event is change on the Input box.
	    this.setState({ searchTerm: event.target.value });
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'h1',
	        { className: 'librivoxSearchHeader' },
	        'Search Libri',
	        _react2.default.createElement(
	          'b',
	          null,
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('input', { type: 'text', placeholder: 'Search', onChange: this.searchTermChange }),
	          _react2.default.createElement(
	            'button',
	            { type: 'submit' },
	            'Search'
	        ...
	        _react2.default.createElement(SearchResultsDisplay, { data: this.props.data, searchTerm: this.state.searchTerm })
	      )
	    );
	  }
	});
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  ...
	  return {
	    saveSearchURL: function saveSearchURL(searchURL) {
	      dispatch(librivoxActions.saveSearchURL(searchURL));
	    },
	    getBookData: function getBookData(searchType, searchTerm) {
	      dispatch(librivoxActions.getBookdata(searchType, searchTerm));
	    },
	    saveBookData: function saveBookData(data) {
	      dispatch(librivoxActions.saveBookData(data));
	    },
	...
	*/
	...
	var AppConnected = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(App); // see connect() function in react-redux
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  { store: _librivoxStore2.default },
	  _react2.default.createElement(
	    _reactRouter.Router,
	    { history: history },
	    _react2.default.createElement(
	      _reactRouter.Route,
	      { path: 'index.html', component: AppConnected },
	      _react2.default.createElement(
	        _reactRouter.IndexRoute,
	        { component: Search },
	        _react2.default.createElement(_reactRouter.Route, { path: 'book/:id', component: BookDataDisplay })
	      )
	    )
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var librivoxStore = (0, _redux.createStore)(_reducers2.default, initialState, (0, _redux.applyMiddleware)(_reduxThunk2.default));

	exports.default = librivoxStore;
	/* 
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rootLibrivoxReducer = (0, _redux.combineReducers)({
	  ...
	  currentBook: currentBook // The currently displayed individual book (or none)
	});
	...
	function currentBook() {
	  ...
	  switch (action.type) {
	    case librivoxActions.SAVE_CURRENT_BOOK:
	      newState = _extends({}, state, { currentBook: action.saveCurrentBook
	      });
	      console.log("currentBook: " + JSON.stringify(newState));
	      return newState;
	    default:
	      return state;
	  }
	...
	function searchURL() {
	  ...
	  switch (action.type) {
	    case librivoxActions.RECEIVED_BOOKS_SUCCESS:
	      return _extends({}, state, { searchURL: action.searchURL, isFetching: false
	      });
	    default:
	      return state;
	  }
	...
	function bookData() {
	  ...
	  switch (action.type) {
	    case librivoxActions.RECEIVED_BOOKS_SUCCESS:
	      var newState = _extends({}, state, { data: action.data // array of objects --  gets rid of the problem of passing an object down through components
	    ...
	    case librivoxActions.BOOK_DATA_FETCH_ERROR:
	      return _extends({}, state, { bookDataFetchError: action.bootDataFetchError
	      });
	    default:
	      return state;
	  }
	...
	exports.default = rootLibrivoxReducer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.saveBookDataFetchError = saveBookDataFetchError;
	...
	*/
	...
	var BOOK_TITLE_FILTER = exports.BOOK_TITLE_FILTER = 'BOOK_TITLE_FILTER';
	...
	function getBookData() {
	  var searchType = arguments.length <= 0 || arguments[0] === undefined ? 'author/' : arguments[0];
	  ...
	  // jsonp(url, opts, fn){
	  return function (dispatch) {
	    // this is a thunk -- action function returns a function
	...
	function saveBookDataFetchError(err) {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(175)('jsonp');
